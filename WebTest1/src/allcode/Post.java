...
public class Post implements Serializable{
	...
	public List <Post> getRespondsList()
	{
		List<Post> responds = new ArrayList<Post>();
		Collection<Post> r = _responses.values();
		Object tempreponds[] = r.toArray();
		for (int i = 0; i < tempreponds.length; i++)
			responds.add((Post)tempreponds[i]);
		return responds;
	}
}
